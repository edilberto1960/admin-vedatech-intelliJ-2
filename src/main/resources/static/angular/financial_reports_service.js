...
angular.module('myApp').factory('FinancialReportsService', ['$http', '$q', function($http, $q){
  ...
  // //  var REST_SERVICE_URI = 'http://localhost:8080/financial_reports/';
  ...
  //   var REST_SERVICE_URI_TYPE_TRANSACTION = 'http://localhost:8080/transactions/';
    ...
    function fetchAllBankAccount() {
        ...
        $http.get(REST_SERVICE_URI+'financial_reports/getAllBankAccounts/')
            .then(
                function (response) {
    ...
    function fetchAllAccounts() {
        var deferred = $q.defer();
        $http.get(REST_SERVICE_URI+'financial_reports/getAllAccounts/')
            .then(
                function (response) {
                    deferred.resolve(response.data);
                },
    ...
    function getTransactionsByBankAccount(user) {
        var deferred = $q.defer();
        $http.post(REST_SERVICE_URI+'financial_reports/incomeStatements/', user)
            .then(
                function (response) {
                    deferred.resolve(response.data);
    ...
    function getAllDeposit(user) {
        var deferred = $q.defer();
        $http.post(REST_SERVICE_URI+'financial_reports/incomeDeposit/', user)
            .then(
                function (response) {
                    deferred.resolve(response.data);
                    console.log("Transactions ", response);
    ...
    function updateUser(user,user2, id) {
        ...
        var deferred = $q.defer();
        $http.put(REST_SERVICE_URI+'financial_reports/'+id,user)
            .then(
                function(response){
    ...
    function deleteUser(id) {
        var deferred = $q.defer();
        $http.delete(REST_SERVICE_URI+'financial_reports/'+id)
            .then(
                function (response) {
                    deferred.resolve(response.data);
                },
